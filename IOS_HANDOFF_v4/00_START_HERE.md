...
## Главный документ для передачи Codex

Перед началом работы обязательно открыть:

- `CODEX_MASTER_HANDOFF_IOS_v1.md`
- `CODEX_FIRST_MESSAGE_IOS.txt`

Первый файл содержит полный порядок завершения проекта.
Второй файл — готовое первое сообщение для Codex.
