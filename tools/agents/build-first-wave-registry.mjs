...
const rules = [
  { RuleId: 'ORCHESTRATOR_SELF_CHANGE', TaskType: 'orchestrator self-change', PathPatterns: ['.codex/agents/ios-agent-orchestrator.toml', 'architecture/agents/overlays/ios-agent-orchestrator.yaml', 'architecture/agents/compositions/ios-agent-orchestrator.yaml', 'tools/agents/orchestrate.mjs'], RequiredAgents: ['agent-governance-auditor', 'security-privacy-auditor'], RequiredControls: ['owner-approval', 'anti-self-review', 'governance-tamper-check'] },
  { RuleId: 'UPSTREAM_PROFILE_MODEL', TaskType: 'upstream/profile/model', PathPatterns: ['architecture/agents/upstream/**', 'architecture/agents/overlays/**', 'architecture/agents/compositions/**', 'architecture/agents/registry/**', '.codex/agents/**'], RequiredAgents: ['ios-agent-orchestrator', 'agent-governance-auditor', 'security-privacy-auditor'], RequiredControls: ['upstream-integrity', 'append-only-overlay', 'no-silent-downgrade'] },
...
const matrix = {
  ...
  AntiTamperPaths: ['AGENTS.md', '**/AGENTS.md', '.codex/agents/**', 'architecture/agents/**', 'docs/agents/**', 'tools/agents/**', 'tools/trusted-governance/**', '.github/workflows/*agent*'],
