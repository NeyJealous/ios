...
TI.Directory = {
  ...
  discoverFromTrades: function() {
    ...
    trades.forEach(function(trade) {
      ...
      if (info && TI.Directory.key(info)) {
        item = TI.Directory.mergeItem(item, info);
      }
  ...
  discoverFromPortfolios: function() {
    ...
    accounts.forEach(function(account) {
      var positions = TI.Directory.fetchPortfolioPositions(account.id);
      ...
      positions.forEach(function(position) {
        ...
        item = TI.Directory.mergeItem(item, TI.Directory.fetchInstrumentInfo(item));

        key = TI.Directory.key(item);
